...
for relative, category in [
    ...
    ("2026_KIISE/04_scripts", "generation_and_verification_scripts"),
    ("2026_KIISE/03_src", "experiment_source_code"),
    ("2026_KIISE/00_env", "environment_specification"),
    ("2026_KIISE/01_infra", "database_environment_specification"),
]:
