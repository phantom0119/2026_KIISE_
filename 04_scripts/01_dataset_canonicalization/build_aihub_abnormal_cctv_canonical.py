#!/usr/bin/env python3
"""Build canonical AI Hub abnormal behavior CCTV workload artifacts."""
...
from vlmdb_workload.adapters.aihub_abnormal_cctv import AIHubAbnormalCCTVAdapter  # noqa: E402
...
def main() -> int:
    args = parse_args()
    adapter = AIHubAbnormalCCTVAdapter(
