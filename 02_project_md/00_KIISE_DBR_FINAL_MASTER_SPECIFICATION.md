...
|---|---|---|---|
| **RQ1** | 순환 결함 진단 및 통제 주입 | [`04_scripts/run_circularity_controlled_injection.py`](../04_scripts/run_circularity_controlled_injection.py)<br>[`04_scripts/verify_circularity_controlled_injection.py`](../04_scripts/verify_circularity_controlled_injection.py) | AI Hub 522 Canonical, VRU 수리판 |
| **RQ2** | 증거 표현 및 다중 이미지 벤치마크 | [`04_scripts/run_storage_unit_benchmark.py`](../04_scripts/run_storage_unit_benchmark.py)<br>[`04_scripts/build_visual_embeddings.py`](../04_scripts/build_visual_embeddings.py) | CLIP ViT-B/32, Qwen3 Embeddings |
| **RQ3 & RQ4** | 검색 계획 비교 및 모달리티 융합 | [`04_scripts/run_retrieval_baselines.py`](../04_scripts/run_retrieval_baselines.py)<br>[`04_scripts/run_multimodal_fusion_baselines.py`](../04_scripts/run_multimodal_fusion_baselines.py) | Faiss, BM25, RRF Ranker |
| **RQ5** | Predicate 부분 색인 및 배포 | [`04_scripts/run_pgvector_partial_index.py`](../04_scripts/run_pgvector_partial_index.py)<br>[`04_scripts/run_pgvector_ann_benchmark.py`](../04_scripts/run_pgvector_ann_benchmark.py) | [`01_infra/docker-compose.pgvector.yml`](../01_infra/docker-compose.pgvector.yml) (:5433) |
| **RQ6** | 3관문 VLM QA 답변 전파 | [`04_scripts/run_multiview_answer_vlm.py`](../04_scripts/run_multiview_answer_vlm.py)<br>[`04_scripts/run_rag_vqa.py`](../04_scripts/run_rag_vqa.py) | AI Hub 다각도 CCTV, Llama-3-Vision, Qwen2-VL |
| **외적 타당성** | 해외/도메인 확장 검증 | [`04_scripts/build_meva_trisource_canonical.py`](../04_scripts/build_meva_trisource_canonical.py)<br>[`04_scripts/score_meva_semantic.py`](../04_scripts/score_meva_semantic.py) | MEVA, UCA Benchmark |
