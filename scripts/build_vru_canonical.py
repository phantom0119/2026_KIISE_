#!/usr/bin/env python3
"""Build canonical VRU-Accident workload artifacts."""
...
from vlmdb_workload.adapters.vru_accident import VRUAccidentAdapter  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--overwrite",
        action="store_true",
        help="Overwrite an existing canonical output directory.",
    )
